...
- **Quick Fill (AI)** *(v1.1, optional)* — describe a purchase ("furniture
  shopping, ₹45,000") and get a drafted set of item rows to explore with. The AI
  only picks the mix of goods and their proportions; the per-unit rates are solved
  ...
  editable markdown file at `lib/data/indian-invoice-items.md`.
